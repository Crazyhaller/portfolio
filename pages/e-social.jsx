...
import esocialImg from '../public/assets/projects/e-social.jpeg'
    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">E-Social</h2>
          <h3>MERN Stack / Redux / Material UI</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This app was built using MERN Stack, Redux, and Material UI. It is a
          ...
          <a
            href="https://github.com/Crazyhaller/E-Social"
            target="_blank"
            rel="noreferrer"
          >
